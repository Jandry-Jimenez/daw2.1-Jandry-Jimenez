...
function pintarSesion()
{
    if(haySesionRAMIniciada()) {
        echo "<span>Sesión iniciada por <a href='UsuarioPerfilVer.php'>$_SESSION[identificador]</a>
        $_SESSION[nombre], $_SESSION[apellidos] <a href = 'SesionCerrar.php'>Cerrar Sesión</a></span>";
    } else {
