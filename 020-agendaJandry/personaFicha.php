    ...
    <select name='categoriaId'>
        <?php
            foreach ($rsCategorias as $filaCategoria) {
                ...
                // Alternativa (peor):
                // if ($cancionId == $personaCategoriaId) echo "<option value='$cancionId' selected='true'>$cancionNombre</option>";
...
<?php if (!$nuevaEntrada) { ?>
    <br />
    <a href='../001%20musica/artistaEliminar.php?id=<?=$id ?>'>Eliminar persona</a>
<?php } ?>

<br />
<br />

<a href='../001%20musica/artistaListado.php'>Volver al listado de personas.</a>
